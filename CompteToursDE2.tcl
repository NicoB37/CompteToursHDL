...
# File: CompteToursDE2.tcl
# Generated on: Sun Oct 17 18:30:33 2021
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "CompteToursDE2"]} {
		puts "Project CompteToursDE2 is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists CompteToursDE2]} {
		project_open -revision CompteToursDE2 CompteToursDE2
	} else {
		project_new -revision CompteToursDE2 CompteToursDE2
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name TOP_LEVEL_ENTITY CompteToursDE2_schema
	set_global_assignment -name ORIGINAL_QUARTUS_VERSION 17.1.0
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "17:09:35  OCTOBER 01, 2021"
	...
	set_global_assignment -name VERILOG_FILE TranscoLeds.v
	set_global_assignment -name VERILOG_FILE Mem.v
	set_global_assignment -name VERILOG_FILE DivFreq.v
	set_global_assignment -name VERILOG_FILE CompteTours.v
	set_global_assignment -name VERILOG_FILE CntNBits.v
	set_global_assignment -name VERILOG_FILE CntMem.v
	set_global_assignment -name POWER_PRESET_COOLING_SOLUTION "23 MM HEAT SINK WITH 200 LFPM AIRFLOW"
	set_global_assignment -name POWER_BOARD_THERMAL_MODEL "NONE (CONSERVATIVE)"
	set_global_assignment -name BDF_FILE CompteToursDE2_schema.bdf
